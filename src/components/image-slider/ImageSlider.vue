<template>
        <div class="slides slides--contained" :class="[effect ? 'effect-1' : 'effect-2']">
            <div v-for="(slide, index) in slides" class="slide" v-bind:class="{'slide--current': index === 0}">
                <div class="slide__img glitch" :style="{backgroundImage: 'url(' + slide.image +')'}">
                    <div v-for="n in 5" class="glitch__img" :style="{backgroundImage: 'url(' + slide.image +')'}"></div>
                </div>
                <div class="slide__text">
                   <h2 class="slide__title">{{ slide.text }}</h2>
                   <h2 class="slide__description">{{ slide.text }}</h2>
                </div>
            </div>
        </div>
</template>
...
<script lang="ts">
    ...
    export default class ImageSlider extends Vue {
        slides = [
            {image:'http://www.fubiz.net/wp-content/uploads/2017/06/Wood-Fire-Art-10.jpg', text: 'ADIDAS NMD' },
            {image:'http://www.fubiz.net/wp-content/uploads/2017/06/Wood-Fire-Art-11.jpg', text: 'REEBOK' },
            {image:'http://www.fubiz.net/wp-content/uploads/2017/06/Wood-Fire-Art-7.jpg', text: 'NIKE 3.26' },
            {image:'http://www.fubiz.net/wp-content/uploads/2017/06/Wood-Fire-Art-8.jpg', text: 'ASICS BLUERED' },
            {image:"http://www.fubiz.net/wp-content/uploads/2017/06/Wood-Fire-Art-9.jpg", text: 'PUMA' }
        ];
        defaultEffect = true;
        ...
        mounted() {
            const slideshow = new GlitchSlideshow(this.$el);
            this.$options.interval = setInterval(() => {
                let number = Math.round(Math.random() * 10);
                this.defaultEffect = number > 5;
